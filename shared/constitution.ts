...
export const CONSTITUTION: ConstitutionLaw[] = [
  ...
  },
  {
    ...
    plain:
      "Any member can see everything the village holds about them, take a copy, settle what is open, and leave — their name scrubbed everywhere while the village's shared record keeps its numbers. Departure is a supported path, not an escape.",
