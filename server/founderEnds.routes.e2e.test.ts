 ...
 * 2026-08-30: the highest band any other suite can reach is 18099
 * (17700 + pid % 400, dryRun.routes and mintVote.routes share it), so a base
 * at 18200 cannot collide with any of them for ANY process id. 400 wide,
 * ending at 18599, well below the ephemeral range Windows hands out (49152+).
 */
