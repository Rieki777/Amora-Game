 ...
 * the highest port any other suite can reach is 17599 (17200 + pid % 400), so
 * a base at 17700 cannot collide with any of them for ANY process id. 400
 * wide, ending at 18099, well below the ephemeral range Windows hands out
 * (49152+).
 */
