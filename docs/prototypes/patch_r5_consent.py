...
src = edit(
    ...
    "    /* THE SHEET GOES, whichever way the walk ended, and the first draft of\n"
    "       this kept it open on a gesture so she could say where the way back in\n"
    "       was. MEASURED: document.elementFromPoint on the centre of the resume\n"
    "       button returned #maiaText. Her sheet is a full-width bottom tenant and\n"
    "       it was sitting on the one control the brief asks to be visible. She\n"
    "       still says the line, still speaks it, and it is still in her log; what\n"
    "       she does not do is hold the bottom of the screen after somebody has\n"
    "       just taken the map back. */\n"
    "    window.jHalt&&jHalt(false);\n"
...
src = edit(
    ...
    "   keepSheet exists for a caller that wants her sheet left up. Nothing passes\n"
    "   true today and the reason is measured: a sheet left up on a phone covers\n"
    "   the bottom band, and the bottom band is where the way back into the walk\n"
    "   lives. D7 has always asserted that ending a walk gives the phone its\n"
    "   screen back, and a gesture is an ending like any other. */\n"
