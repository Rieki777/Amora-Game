...
- `tokens` table rows (a fresh village seeds gratitude/equity/voice/credits,
  ...
  edit and says why.
- The brand overlay, the `brand` row of `app_config`, via the admin Setup Wizard ("Make This Yours") — identity,
...
- **The overlay:** the `brand` row of `app_config` (a `dbDocument`, edited by the admin
