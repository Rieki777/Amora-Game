...
| 14 · Builders' pool | **Building** | The eligibility rule (`pricing` present means not pool-eligible) is checked by the listing lint. The distribution mechanics and the account linkage are a separate build. |
